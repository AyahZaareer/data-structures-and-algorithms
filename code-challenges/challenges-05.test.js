...
const addValues = (arr) => {
  // Solution code here...
  return(arr.reduce((acc,value,index)=> acc += value,0));
...
const addPurchases = (arr) => {
  // Solution code here...
  return( arr.reduce((acc,value,index)=>acc += value.purchasePrice,0));
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  return(arr.reduce((acc,value,index)=>index+1));
...
const reversedString = (str) => {
  ...
  // return str.reduce(item => item.split('').reverse().join(''));
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  return arr.reduce((acc,value,index)=>value.children? acc +=value.children.length:acc,0);
};
...
const countPrimeNumbers = (arr) => {
  // Solution code here...
  return arr.reduce((acc,value,index)=> isPrime(value)?acc+1:acc,0);
};
...
const extractStat = (statName, arr) => {
  // Solution code here...
  return arr.reduce((acc,value,index)=>value.stat.name ===statName?value:acc,0);
};
